...
export default {
  ...
  data() {
    return {
                      crumbs: ['Home', 'Report Menu','Production Report'],
      items: [
        {
          text: "Home",
          disabled: false,
  ...
  methods: {
    ...
    createPDF() {
      ...
      doc.text(14, 7.5, "Production Report");
      ...
      let d = new Date();
      doc.save(
        `Production_Reports ${d.toISOString().slice(0, 10) +
          " " +
          d
            .toTimeString()
            .split("(")[0]
    ...
    searchNew: function(machine_id, startDate, endDate) {
      ...
      let config = {
        method: "get",
        url: `${constants.backend_url}/getProductionData${params}`,
        headers: {
