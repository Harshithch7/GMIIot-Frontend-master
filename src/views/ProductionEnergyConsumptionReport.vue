              ...
              <v-list>
                <v-list-item>
                  <v-list-item-action>
                    <vue-json-to-csv
                      :json-data="dataDownload"
                      :csv-title="'Production Energy Consumption Report Data'"
                    >
...
export default {
  ...
  data() {
    return {
                                  crumbs: ['Home', 'Report Menu','Production Energy Consumption Report'],
      items: [
        {
          text: "Home",
          disabled: false,
        ...
        {
          text: "Production Energy Consumption Report",
          disabled: true,
        },
      ],
      showWarning: false,
  ...
  methods: {
    ...
    createPDF() {
      ...
      doc.text(14, 7.5, "Production Energy Consumption Report");
      ...
      let d = new Date();
      doc.save(
        `Production_Energy_Consumption_Reports ${d.toISOString().slice(0, 10) +
          " " +
          d
            .toTimeString()
            .split("(")[0]
    ...
    searchNew: function(machine_id, startDate, endDate) {
      ...
      let config = {
        method: "get",
        url: `${constants.backend_url}/getProductionEnergyConsumptionData${params}`,
        headers: {
...
sortable: true,        },
                {
          text: "Power Per Component(Watts)",
          value: "power_per_component",
sortable: true,        }
      ];
