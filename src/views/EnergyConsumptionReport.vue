              ...
              <v-list>
                <v-list-item>
                  <v-list-item-action>
                    <vue-json-to-csv
                      :json-data="dataDownload"
                      :csv-title="'Energy Consumption Report Data'"
                    >
...
export default {
  ...
  data() {
    return {
                            crumbs: ['Home', 'Report Menu','Energy Consumption Report'],
      ...
      items: [
        ...
        {
          text: "Energy Consumption Report",
          disabled: true,
        },
      ],
      showWarning: false,
  ...
  methods: {
    ...
    createPDF() {
      ...
      doc.text(14, 7.5, "Energy Consumption Report");
      ...
      let d = new Date();
      doc.save(
        `Energy_Consumption_Report ${d.toISOString().slice(0, 10) +
          " " +
          d
            .toTimeString()
            .split("(")[0]
    ...
    searchNew: function(machine_id, startDate, endDate) {
      ...
      let config = {
        method: "get",
        url: `${constants.backend_url}/getEnergyConsumptionData${params}`,
        headers: {
